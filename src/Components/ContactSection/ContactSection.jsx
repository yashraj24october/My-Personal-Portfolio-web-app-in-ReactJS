...
<div className='row'>
  ...
  <h4 className='contact-info-heading' data-aos = 'fade'>Contact Information</h4>
  <p data-aos = 'fade'>Let’s connect and start crafting something unique and impactful.<br/><br/> <strong style={{color:'#fff'}} data-aos = 'fade'>Turn Your Vision into Reality!</strong><br/>Whether you’re looking to build a website, solve a tech challenge, or brainstorm a fresh design, I’m here to help. Drop a message, and let’s get started!</p>
  
{
 ...
 return <ContactCard key={index} icon={item.icon} label={item.label} data={item.data}/>
  ...
  <div className="col-md-8 col-12 contact-form" data-aos = 'fade-up'><ContactForm/></div>
</div>
</div>
<Footer/>
    </div>
